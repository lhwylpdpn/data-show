...
<!--[if gt IE 8]><!--> <html> <!--<![endif]-->
    ...
    <body>
        ...
        <![endif]-->
        <div id="split-container" style="height:528px">

            <div id="graph-container" style="height:528px">
                <div id="graph" style="height:528px"></div>
            </div>
            <div id="docs-container" style="height:528px">
